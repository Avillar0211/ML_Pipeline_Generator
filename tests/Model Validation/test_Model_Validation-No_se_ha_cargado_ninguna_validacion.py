...
try: 
    ...
    assert str(e) ==  'No se ha cargado ningúna validacion que se pueda aplicar sobre el modelo', 'No comprueba bien que en el Model Validation se estén intentando procesar un conjunto vacio de validaciones'
    exit
